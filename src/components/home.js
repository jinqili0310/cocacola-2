 ...
 * @LastEditTime: 2020-11-02 08:14:35
 * @FilePath: /cocacola-2/src/components/home.js
 */
					...
					<Col className="col-card">
						<Card className="product-card product-cc">
							...
							<Card.Body className="product-card-body">
								...
								<Button variant="dark" className="button-style" href="/cocacola-2/#/products/coca-cola/explore/">
									EXPLORE
								</Button>
							</Card.Body>
						</Card>
